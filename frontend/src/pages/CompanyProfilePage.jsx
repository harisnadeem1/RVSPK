      ...
      <section className="section-spacing bg-muted">
        <div className="container-custom px-4 sm:px-6">
          ...
          >
            ...
            <div>
              <span className="text-[15px] font-semibold tracking-[0.2em] uppercase text-accent mb-2 inline-block">
                Registered Company
              </span>
              ...
              <p className="text-base sm:text-sm text-muted-foreground leading-relaxed max-w-2xl">
          ...
          >
            {keyFacts.map((fact, i) => (
              ...
              >
                ...
                <div>
                  <p className="text-base text-muted-foreground uppercase tracking-wider mb-0.5">
                    {fact.label}
                  </p>
                  <p className="text-base sm:text-base font-bold text-foreground">{fact.value}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
        ...
        <div className="container-custom px-4 sm:px-6">
          ...
          >
            {companyDetails.map((detail, i) => (
              ...
              >
                <p className="text-base font-semibold uppercase tracking-wider text-muted-foreground mb-1">
                  {detail.label}
                </p>
                {detail.href ? (
                  <a
                    ...
                    className="text-base sm:text-base font-medium text-accent hover:text-accent/80 transition-colors"
                  >
                    {detail.value}
                  </a>
                ) : (
        ...
        <div className="container-custom px-4 sm:px-6">
          ...
          >
            ...
            >
              ...
              <h3 className="text-base sm:text-base font-semibold text-foreground mb-3 leading-snug">
                Directors
              </h3>
              ...
              {[
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg sm:text-base font-semibold text-foreground">{block.title}</h3>
                  </div>
                  <ul className="space-y-2">
                    {block.items.map((item) => (
                      <li key={item} className="flex items-center gap-2">
                        <CheckCircle className="h-3.5 w-3.5 text-accent flex-shrink-0" />
                        <span className="text-base sm:text-sm text-muted-foreground">{item}</span>
                      </li>
                    ))}
                  </ul>
                </motion.div>
