...
function Footer() {
  ...
  Right Vision Securities (Pvt.) Limited is a SECP-licensed and PMEX-registered futures brokerage firm
  and part of the Right Vision Group (est. 2007). We provide transparent, reliable, and efficient
  ...
  compliance, and client success.
          ...
          <div className="lg:col-span-2">
            <h3 className="text-sm font-semibold uppercase tracking-widest text-primary-foreground/50 mb-2">
              About Us
            </h3>
            ...
            <h3 className="text-sm font-semibold uppercase tracking-widest text-primary-foreground/50 mb-2 mt-4">
  Reports
</h3>
