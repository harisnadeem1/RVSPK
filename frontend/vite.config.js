...
export default defineConfig({
  ...
  "default-src 'self'",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://s3.tradingview.com https://*.tradingview.com https://*.tradingview-widget.com",  // ← added blob:
  "worker-src 'self' blob:",                                                                                                                        // ← simplified
  "frame-src 'self' http://localhost:5000 https://s3.tradingview.com https://www.tradingview.com https://*.tradingview.com https://*.tradingview-widget.com",
